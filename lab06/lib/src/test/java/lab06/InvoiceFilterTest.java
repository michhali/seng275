...
class InvoiceFilterTest {
    ...
    void allHighValueInvoices() {
        ...
        issuedInvoicesMock = mock(IssuedInvoices.class);
    ...
    void someLowValueInvoices() {
        ...
        when(issuedInvoicesMock.all()).thenReturn(List.of(
                new Invoice(50),  // Should stay
                new Invoice(150), // Should be filtered out
                new Invoice(99)   // Should stay
        ));


        assertThat(invoiceFilter.lowValueInvoices())
                .containsExactly(new Invoice(50), new Invoice(99));
